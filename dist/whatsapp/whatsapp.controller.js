...
let WhatsappController = class WhatsappController {
    ...
    loadReminderMessage() {
        try {
            ...
            console.error(...oo_tx(`3223351245_48_6_48_62_11`, 'Error loading reminder messages:', error));
            return {};
        }
    }
        ...
        for (const reminder of reminders) {
            ...
            for (const phone of patient_cel) {
                try {
                    ...
                    console.log(...oo_oo(`3223351245_110_10_110_67_4`, `Failed to send message to ${phone}:`, error));
                }
            }
        }
    ...
    async sendRescheduledMessage(user, body, request) {
        ...
        try {
            ...
            console.error(...oo_tx(`3223351245_281_6_281_64_11`, 'Error sending rescheduled message:', error));
