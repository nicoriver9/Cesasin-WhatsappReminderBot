...
export class WhatsappController {
  ...
  async getRescheduleMessages() {
    try {
      ...
      return {
        message: "Error retrieving reschedule messages",
        error: error.message,
      };
    }
  }
  ...
  async getPatientResponses(@User() user: any) {
    ...
    try {
      ...
      return {
        message: "Error retrieving patient responses",
        error: error.message,
      };
    }
  }
  ...
  async sendRescheduledMessage(
    ...
    try {
      ...
      if (!reschedule && !patientResponse) {
        return {
          message: "Patient not found or not eligible for rescheduling",
        };
      }

      // Obtener el número de teléfono del paciente
      const phoneNumber =
        reschedule?.patient_phone || patientResponse?.patient_phone;
      ...
      return {
        message: "Error sending rescheduled message",
        error: error.message,
      };
    }
  }
  ...
  async getConfirmedAppointments() {
    try {
      ...
      return {
        message: "Error retrieving confirmed appointments",
        error: error.message,
      };
    }
  }
  ...
  async getCancelledAppointments() {
    try {
      ...
      return {
        message: "Error retrieving cancelled appointments",
        error: error.message,
      };
    }
  }
