...
let WhatsappService = WhatsappService_1 = class WhatsappService {
    constructor(prisma) {
        ...
        this.client.on("disconnected", async (reason) => {
            console.log(...oo_oo(`984314094_72_6_72_40_4`, "client disconnected"));
    ...
    loadConversationalResponses() {
        try {
            ...
            console.error(...oo_tx(`984314094_179_6_179_69_11`, "Error loading conversational responses:", error));
            return {};
        }
    }
    ...
    loadReminderResponses() {
        try {
            ...
            console.error(...oo_tx(`984314094_387_6_387_63_11`, "Error loading reminder responses:", error));
            return {};
        }
    }
    async handleReminderMessage(message, reminderMessage) {
        ...
        switch (body) {
            case "1":
                ...
                await this.updatePatientReminder(from, patientFullName, newTaskStatus, 2);
                break;
            case "2":
                console.log(...oo_oo(`984314094_494_8_494_29_4`, 'case2 '));
                newTaskStatus = 2;
                ...
                await this.updatePatientReminder(from, patientFullName, newTaskStatus, 1);
                break;
            case "3":
                newTaskStatus = 3;
    ...
    async handleInitialGreeting(from, responses, contactName, patientFullName, appointmentDate, doctorName) {
